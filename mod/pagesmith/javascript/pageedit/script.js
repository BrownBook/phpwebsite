...
$(document).ready(function () {
  ...
  $("#page-title-edit").popover({
    ...
    trigger: "hover",
    content:
      '<span style="margin:0px;padding:0px;font-size:16px;font-weight:bold">Click on ' +
      "title to edit</span>",
  });
  $(".block-edit").popover({
    html: true,
    ...
    trigger: "hover",
    content:
      '<span style="font-size:16px;font-weight:bold">Click on text to edit</span>',
  });
});
...
jQuery.fn.center = function (absolute) {
  return this.each(function () {
    ...
    if (absolute) {
      t.css({
        marginTop:
          parseInt(t.css("marginTop"), 10) + jQuery(window).scrollTop(),
        marginLeft:
          parseInt(t.css("marginLeft"), 10) + jQuery(window).scrollLeft(),
      });
    }
  });
};
